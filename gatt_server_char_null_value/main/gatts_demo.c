...
static void gatts_profile_b_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_CREATE_EVT:
      ...
      esp_bt_uuid_t char_uuid = {
        ...
        .uuid.uuid128 = {0xe3, 0x07, 0xa5, 0x63, 0x2b, 0x04, 0xb8, 0xaf, 0xa0, 0x4b, 0xf9, 0xc7, 0xe2, 0x60, 0x4c, 0x40},
      };
      esp_gatt_char_prop_t property = ESP_GATT_CHAR_PROP_BIT_WRITE;
      esp_attr_value_t config_char_val = {.attr_value = NULL, .attr_max_len = 0, .attr_len = 0};
      esp_err_t add_char_ret = esp_ble_gatts_add_char(
          gl_profile_tab[PROFILE_B_APP_ID].service_handle, &char_uuid,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
          property, NULL, NULL);
        // a_property = ESP_GATT_CHAR_PROP_BIT_READ | ESP_GATT_CHAR_PROP_BIT_WRITE | ESP_GATT_CHAR_PROP_BIT_NOTIFY;
        // esp_err_t add_char_ret = esp_ble_gatts_add_char(gl_profile_tab[PROFILE_A_APP_ID].service_handle, &gl_profile_tab[PROFILE_A_APP_ID].char_uuid,
